...
export const AgentStateSchema = z.object({
  ...
  // RAG answer generated by managerNode when query_knowledge_base was called.
  // Appended to the summary by summaryNode so the user sees the answer inline.
  ragContext: z.string(),
...
export const GraphState = Annotation.Root({
  ...
  // RAG answer string written by managerNode after generating an LLM answer from
  // query_knowledge_base results. Empty string when no knowledge base query ran.
